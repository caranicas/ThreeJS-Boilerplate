...
OrbitalControls = (function(_super) {
  __extends(OrbitalControls, _super);

  OrbitalControls.prototype.EPS = 0.000001;

  OrbitalControls.prototype.rotateStart = new THREE.Vector2();

  OrbitalControls.prototype.rotateEnd = new THREE.Vector2();

  OrbitalControls.prototype.rotateDelta = new THREE.Vector2();

  OrbitalControls.prototype.panStart = new THREE.Vector2();

  OrbitalControls.prototype.panEnd = new THREE.Vector2();

  OrbitalControls.prototype.panDelta = new THREE.Vector2();

  OrbitalControls.prototype.dollyStart = new THREE.Vector2();

  OrbitalControls.prototype.dollyEnd = new THREE.Vector2();

  OrbitalControls.prototype.dollyDelta = new THREE.Vector2();

  OrbitalControls.prototype.phiDelta = 0;

  OrbitalControls.prototype.thetaDelta = 0;

  OrbitalControls.prototype.scale = 1;

  OrbitalControls.prototype.panVec = new THREE.Vector3(0, 0, 0);

  OrbitalControls.prototype.lastPosition = new THREE.Vector3(0, 0, 0);

  OrbitalControls.prototype.STATE = {
    NONE: -1,
    ROTATE: 0,
    DOLLY: 1,
    PAN: 2,
  ...
  OrbitalControls.prototype.state = -1;

  OrbitalControls.prototype.changeEvent = {
    type: 'change'
  };

  function OrbitalControls(object, domElement, localElement) {
  ...
  OrbitalControls.prototype.initalizeEvents = function() {
  ...
  OrbitalControls.prototype.rotateLeft = function(angle) {
    if (angle === void 0) {
  ...
  OrbitalControls.prototype.rotateUp = function(angle) {
    if (angle === void 0) {
      angle = this.getAutoRotationAngle();
    }
  ...
  OrbitalControls.prototype.panLeft = function(distance) {
    var panOffset, te;
  ...
  OrbitalControls.prototype.panUp = function(distance) {
    var panOffset, te;
    panOffset = new THREE.Vector3();
    te = this.object.matrix.elements;
  ...
  OrbitalControls.prototype.pan = function(delta) {
  ...
  OrbitalControls.prototype.dollyIn = function(dollyScale) {
  ...
  OrbitalControls.prototype.dollyOut = function() {
    var dollyScale;
    if (dollyScale === void 0) {
      dollyScale = this.getZoomScale();
    }
  ...
  OrbitalControls.prototype.update = function() {
  ...
  OrbitalControls.prototype.onMouseDown = function(event) {
  ...
  OrbitalControls.prototype.onMouseUp = function() {
    if (this.enabled === false) {
      return;
    }
  ...
  OrbitalControls.prototype.onMouseMove = function(event) {
    var element;
    if (this.enabled === false) {
      return;
    }
  ...
  OrbitalControls.prototype.onMouseWheel = function(event) {
    var delta;
  ...
  OrbitalControls.prototype.onKeyDown = function(event) {
    var needUpdate;
    if (this.enabled === false) {
      return;
    }
  ...
  OrbitalControls.prototype.touchstart = function(event) {
    var distance, dx, dy;
    if (this.enabled === false) {
      return;
    }
  ...
  OrbitalControls.prototype.touchmove = function(event) {
  ...
  OrbitalControls.prototype.touchend = function() {
    if (this.enabled === false) {
      return;
    }
    return this.state = this.STATE.NONE;
  ...
  OrbitalControls.prototype.getZoomScale = function() {
    return Math.pow(0.95, this.zoomSpeed);
  };

  OrbitalControls.prototype.getAutoRotationAngle = function() {
